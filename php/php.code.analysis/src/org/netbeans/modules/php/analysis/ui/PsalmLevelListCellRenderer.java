...
public class PsalmLevelListCellRenderer implements ListCellRenderer<String> {

    private final ListCellRenderer<? super String> defaultRenderer;

    public PsalmLevelListCellRenderer(ListCellRenderer<? super String> defaultRenderer) {
