...
public final class AnalysisOptions {
    ...
    public static final int PSALM_MIN_LEVEL = Integer.getInteger("nb.psalm.min.level", 0); // NOI18N
    public static final int PSALM_MAX_LEVEL = Integer.getInteger("nb.psalm.max.level", 9); // NOI18N
    ...
    public static String getValidPsalmLevel(String level) {
        if (Psalm.MAX_LEVEL.equals(level)) {
            return level;
        }
        String psalmLevel;
        try {
